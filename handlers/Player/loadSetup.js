...
module.exports = async (client) => {
    ...
    client.enSwitch = new ActionRowBuilder()
        .addComponents([
            new ButtonBuilder()
                .setStyle(ButtonStyle[enable.song.style])
                .setCustomId("ssong")
                .setLabel(enable.song.label)
                .setEmoji(enable.song.emoji),
            new ButtonBuilder()
    ...
    client.diSwitch = new ActionRowBuilder()
        .addComponents([
            new ButtonBuilder()
                .setStyle(ButtonStyle[disable.song.style])
                .setCustomId("ssong")
                .setLabel(disable.song.label)
                .setEmoji(disable.song.emoji),
            new ButtonBuilder()
