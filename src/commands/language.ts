    ...
    data: new discord.SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option
                ...
                .setRequired(true)
                .addChoices(
                    { name: "User", value: "user", name_localizations: localizationManager.getCommandLocalizations('commands.language.options.scope.choices.user') },
                    { name: "Server", value: "server", name_localizations: localizationManager.getCommandLocalizations('commands.language.options.scope.choices.server') },
                    { name: "Reset", value: "reset", name_localizations: localizationManager.getCommandLocalizations('commands.language.options.scope.choices.reset') }
                )
        )
        .addStringOption((option) =>
            option
