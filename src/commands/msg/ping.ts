...
const command: Command = {
     ...
     */
    execute: async (client: discord.Client, message: discord.Message, args: Array<string>): Promise<void> => {
        try {
            const chan = message.channel as discord.GuildTextBasedChannel | discord.DMChannel;
            ...
            await sent.edit({ content: '', embeds: [embed] }).catch(console.error);
        } catch (error) {
