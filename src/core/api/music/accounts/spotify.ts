...
const generateHTML = (options: { title: string; icon: string; iconColor: string; heading: string; message: string; submessage?: string; username?: string }): string => {
	const { title, icon, iconColor, heading, message, submessage, username } = options;
