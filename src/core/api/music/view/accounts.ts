export const generateHTML = (options: { title: string; icon: string; iconColor: string; heading: string; message: string; submessage?: string; username?: string; platformLogo?: string }): string => {
